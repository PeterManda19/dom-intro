...
// Usage:
const billWidget = BillWithSettings();
billWidget.updateSettings(); // Call this function to update the settings
billWidget.handleAddButtonPress(); // Call this function to handle the add button press
